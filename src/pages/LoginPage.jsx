...
export default function LoginPage() {
  ...
  function handleSignIn() {
    if (isStandalone) {
      // PWA standalone mode: open browser to sign in, then come back
        ...
        {isStandalone ? (
          <div>
            <p className="text-neutral-400 text-xs mb-4">
              Sign in via Chrome first, then re-open this app.
            </p>
            <button
              onClick={handleSignIn}
              className="w-full flex items-center justify-center gap-3 bg-amber-500 rounded-xl px-4 py-3 text-black font-semibold hover:bg-amber-400 transition shadow-sm"
            >
